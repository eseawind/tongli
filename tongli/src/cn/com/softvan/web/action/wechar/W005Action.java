/*
 * 微信服务_自动回复(关键字)_音乐消息 ActionClass
 *
 ...
 * 
 */
public class W005Action extends BaseAction {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -3061791975484213551L;
	private static final transient Logger log = Logger.getLogger(W005Action.class);
	...
	public String save() {
		...
		if(bean!=null){
			String msg="1";
			try {
				if(!Validator.notEmpty(bean.getTitle())
					&& !Validator.notEmpty(bean.getMusicurl())){
					msg="保存失败!信息为空!";
				}else{
