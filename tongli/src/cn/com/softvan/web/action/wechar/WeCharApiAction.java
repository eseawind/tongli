...
import cn.com.softvan.bean.wechar.TcWxUserBean;
...
import cn.com.softvan.bean.wechar.reply.WxReplyNewsMsg;
...
import cn.com.softvan.service.wechar.ITcWxUserManager;
import cn.com.softvan.web.action.BaseAction;
public class WeCharApiAction extends BaseAction {
	private static final transient Logger log = Logger.getLogger(WeCharApiAction.class);
...
//					-------------下载视频-----------
			...
			if(media_flag){
				...
				WeCharUtil.send(replyMsg2, response.getOutputStream());
			}
			//TODO--保存接收到的信息--
	...
	private void reply(String text, HttpServletResponse response,WxReplyMsg replyMsg) throws JDOMException, IOException{
		...
		//--------------判断数据是否缓存--------------
		if(!"1".equals(jedisHelper.get("tc_wechar_info_cache_flag"))){
