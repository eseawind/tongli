/*
 * 微信服务_自动回复(关键字)_文本消息 ActionClass
 *
 ...
 * 
 */
public class W009Action extends BaseAction {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -3061791975484213551L;
	private static final transient Logger log = Logger.getLogger(W009Action.class);
	/**BEAN类  微信资源信息*/
	...
	public String save() {
		...
		if(bean!=null){
			String msg="1";
			try {
				if(!Validator.notEmpty(bean.getContent())){
					msg="保存失败!信息为空!";
				}else{
					if(bean.getContent().length()>=1100){
						msg="保存失败!信息超过最大长度,文本信息最多1100字!";
					}else{
