...
import cn.com.softvan.bean.wechat.send.FansCountBean;
import cn.com.softvan.bean.wechat.send.ImgFileBean;
import cn.com.softvan.bean.wechat.send.ImgTextBean;
import cn.com.softvan.bean.wechat.send.ImgTextMsgListBean;
import cn.com.softvan.bean.wechat.send.LoginJsonBean;
import cn.com.softvan.bean.wechat.send.MsgBean;
import cn.com.softvan.bean.wechat.send.MsgJsonBean;
import cn.com.softvan.bean.wechat.send.MsgTypeBean;
import cn.com.softvan.common.HtmlUtil;

import com.alibaba.fastjson.JSON;

public class WeChatClent {
    private final static Log log = LogFactory.getLog(WeChatClent.class);
    ...
    public WeChatClent(String user, String pwd) {
        this.loginUser = user;
        this.loginPwd = pwd;
    }
...
//            System.out.println("==html1=="+html);
    ...
    public static void main(String[] args) throws Exception {
        ...
        WeChatClent wx = new WeChatClent(LOGIN_USER, LOGIN_PWD);
        wx.login();
        wx.getCookiestr();
