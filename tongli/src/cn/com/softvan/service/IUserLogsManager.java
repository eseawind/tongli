...
public interface IUserLogsManager {
	 ...
	 * @return
	 */
	public String deleteUserLogs(BaseUserLogsBean bean);
	 ...
	 * @return
	 */
	public List<BaseUserLogsBean> findBaseUserLogsbeanIsPage(
			BaseUserLogsBean bean);
	 ...
	 * @return
	 */
	public BaseUserLogsBean findBaseUserLogsbeanById(BaseUserLogsBean bean);
}
