...
public interface ITcSysVariableDao {
     ...
     * 详情
     */
    TcSysVariableBean selectByPrimaryKey(IEntity dto);
	 ...
	 * @return 处理结果
	 */
	public List<TcSysVariableBean> findDataIsPage(IEntity dto);
	/**
	 * <p>信息列表。</p>
	 * <ol>[功能概要] 
	 * <div>信息检索。</div>
	 ...
	 * @return 处理结果
	 */
	public List<TcSysVariableBean> findDataIsList(IEntity dto);
	/**
	 * <p>信息列表。</p>
	 * <ol>[功能概要] 
	 * <div>信息检索。</div>
