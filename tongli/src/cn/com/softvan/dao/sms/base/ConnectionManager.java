...
public final class ConnectionManager {
   ...
   static{
 	   try {
		   ...
		   jdbc_user = properties.getProperty("db1.username");
		   jdbc_password = properties.getProperty("db1.password");
		   jdbc_driver = properties.getProperty("db1.driverClassName");
		   jdbc_url = properties.getProperty("db1.url");
		} catch (IOException e) {
			e.printStackTrace();
		}
   }
