...
<link rel="stylesheet" href="${basePath}<%=WebUtils.setVersion("/css/reset.css") %>" type="text/css">
...
<script type="text/javascript" src="${basePath}<%=WebUtils.setVersion("/js/global.js")%>"></script>
<link rel="stylesheet" href="${basePath}<%=WebUtils.setVersion("/css/style.css")%>" type="text/css">