	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#sys6,#sys6_sub_menu_l1_sub_menu_l4').addClass('active');
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						短消息 回收站 <small><span class="help-inline">展示所有XX</span></small>
					</h3>
								...
								<c:if test="${bean.sms_status=='3'}">已发送</c:if>
									...
									<td>
										<a href="javascript:void(0)"   class="btn purple" 
											onclick="if(confirm('确认恢复吗?')){location.href='${basePath}/h/s005_recovery.ac?id=${bean.sms_id}'};"
											rel="nofollow">恢复</a>
											<a href="javascript:void(0)" class="btn btn-danger"
										onclick="if(confirm('确认删除吗?删除后不可恢复!')){location.href='${basePath}/h/s005_delxx.ac?id=${bean.sms_id}'};">删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
