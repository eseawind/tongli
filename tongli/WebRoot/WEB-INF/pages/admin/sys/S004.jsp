		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						通讯录管理 <small><span class="help-inline">展示所有</span></small>
					</h3>
						...
						<table class="table table-condensed table-striped">
							<tbody>
								...
								<tr>
									...
									<td><a href="${basePath}/h/s004_edit.ac?id=${bean.id}" class="btn edit green">编辑</a>
										<a href="javascript:void(0)" class="btn btn-danger"
										onclick="if(confirm('确认删除吗?')){location.href='${basePath}/h/s004_del.ac?id=${bean.id}'};">删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
