	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#student,#student_sub_menu_l3').addClass('active');
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						班级列表 <small><span class="help-inline">展示所有未删除的班级信息</span></small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li><i class="fa fa-home"></i> <a
							href="${basePath }/home_init.ac">Home</a> <i
							class="fa fa-angle-right"></i></li>
						<li><a href="${basePath }/h/c401_init.ac">班级管理</a> <i class="fa fa-angle-right"></i></li>
						<li>班级列表</a> </li>
					</ul>
								...
								<c:choose>
									...
									<c:otherwise>
										<div class="alert alert-success">
											<button class="close" data-dismiss="alert"></button>
											<strong>Success!</strong> 班级操作成功。
										</div>
									</c:otherwise>
								</c:choose>
							</c:if>
							<div class="btn-toolbar">
								<a href="${basePath}/h/c401_edit.ac" class="btn btn-primary">新增班级</a>
							</div>
							<table class="table table-condensed table-striped">
								<tbody>
									<tr>
										<th class="col-md-3">更新时间</th>
										<th class="col-md-6">班级名称</th>
									...
									<tr>
										...
										<td>${bean.name}</td>
										<td><%-- <a
											href="${basePath}/h/c401_view.ac?id=${bean.id}"
											class="btn  btn-info" target="_blank">详情</a> --%> <a
											href="${basePath}/h/c401_edit.ac?id=${bean.id}"
											class="btn edit green">编辑</a> <a href="javascript:void(0)"   class="btn btn-danger" 
											onclick="if(confirm('确认删除吗?')){location.href='${basePath}/h/c401_del.ac?id=${bean.id}'};"
											rel="nofollow">删除</a></td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
							<customtag:pagingext func="loadUrlPage" params="'h/c401_','init'" />
						</div>
					</div>
				</div>
			</div>
