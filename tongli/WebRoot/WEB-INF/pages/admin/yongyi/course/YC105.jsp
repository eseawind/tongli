	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#sys10,#sys10_sub_menu_li_4_sub_menu_1').addClass('active');
					...
					<div class="row-fluid">
						<div class="col-md-12">
							...
							<div class="btn-toolbar">
								<a href="${basePath}/h/yc105_edit.ac" class="btn btn-primary">新增地址</a>
							</div>
							<table class="table table-condensed table-striped">
								<tbody>
									...
									<tr>
										...
										<td>${bean.addres}</td>
										<td><%-- <a
											href="${basePath}/h/yc105_view.ac?id=${bean.id}"
											class="btn  btn-info" target="_blank">详情</a> --%> <a
											href="${basePath}/h/yc105_edit.ac?id=${bean.id}"
											class="btn edit green">编辑</a> <a href="javascript:void(0)"   class="btn btn-danger" 
											onclick="if(confirm('确认删除吗?')){location.href='${basePath}/h/yc105_del.ac?id=${bean.id}'};"
											rel="nofollow">删除</a></td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
							<customtag:pagingext func="loadUrlPage" params="'h/yc105_','init'" />
						</div>
					</div>
				</div>
			</div>
