	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#sys10,#sys10_sub_menu_li_1_sub_menu_2').addClass('active');
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="javascript:void(0)"   class="btn purple" 
											onclick="if(confirm('确认恢复吗?')){location.href='${basePath}/h/yc101_recovery.ac?id=${bean.id}'};"
											rel="nofollow">恢复</a>
											<a href="javascript:void(0)" class="btn btn-danger"
										onclick="if(confirm('确认删除吗?删除后不可恢复!')){location.href='${basePath}/h/yc101_delxx.ac?id=${bean.id}'};">删除</a>
											</td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
							<customtag:pagingext func="loadUrlPage" params="'h/yc101_','recycle'" />
						</div>
					</div>
				</div>
			</div>
