...
<link rel="stylesheet" type="text/css" href="${basePath}/plugins/q+/jsLib/jquery-smartMenu/css/smartMenu.css">
	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#consult,#consult_sub_menu_l1').addClass('active');
			...
			//digon
			function newWins(tr_id,title,src,id){
				jQuery.ajax({
					//async : false,
					url : src,
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						客服咨询 <small><span class="help-inline">全部咨询信息</span></small>
					</h3>
				...
				<div class="col-md-12">
					<div class="row-fluid">
						<div class="col-md-12">
							...
							<table class="table table-condensed table-striped">
								<tbody>
									...
									<tr id="tr_td_a_${i.index}">
										...
										<td>
											<a href="javascript:;" 
											onclick="newWins('tr_td_a_${i.index}','${bean.user_name}','${basePath}/h/c301_access.ac?id=${bean.id}&oid=${bean.user_id}','${bean.id}');"
							...
							<customtag:pagingext func="loadUrlPage" params="'h/c301_','init'" />
						</div>
					</div>
				</div>
			</div>
