						...
						<c:if test="${bean.type==0}">
								<div class="col-md-12" >
									...
									<table class="table table-striped table-condensed">
										...
										<div class="form-group"> <label  style="margin-top: -8px;">游泳技能</label> <div class=""> 
									...
									<c:if test="${bean.type==1}">
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label  style="margin-top: -8px;">篮球</label>
												<div class="">
											...
											<div class="form-group">
												<label  style="margin-top: -8px;">网球</label>
												<div class="">
											...
											<div class="form-group">
												<label  style="margin-top: -8px;">羽毛球</label>
												<div class="">
											...
											<div class="form-group">
												<label  style="margin-top: -8px;">空手道</label>
												<div class="">
											...
											<div class="form-group">
												<label  style="margin-top: -8px;">轮滑</label>
												<div class="">
											...
											<div class="form-group"> <label  style="margin-top: -8px;">游泳</label> 
												<div class=""> 
