		...
		<table  class="table table-striped table-condensed" >
			...
			<tr>
				<td align="left" colspan="2">
					<form id="${bean.id}" accept-charset="UTF-8"  action="${basePath}/w/t001_save.ac"  method="post">
						<s:token></s:token>
			...
			<tr>
				<td align="left" >
					<form id="fileupload${bean.id}" action="" method="POST" >
						...
						<table role="presentation" class="table table-striped table-condensed col-xs-12" style="text-align: center;">
							<thead>
								<tr style="height: 0px;">
...
<script type="text/javascript">
	...
	function submitFrom3(from_id) {
		//登录认证
		loginCheck();
		jQuery("#"+from_id).attr('action','${basePath}/w/t001_savePic.ac');
