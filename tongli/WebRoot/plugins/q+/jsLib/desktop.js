...
myLib.desktop.win={
	winHtml:function(title,url,id){
		...
		+title
		+"</b><span class='win_btnblock'><a href='javascript:;' class='winMinimize' title='最小化'></a><a href='javascript:;' class='winMaximize' title='最大化'></a><a href='javascript:;' class='winHyimize' title='还原'></a><a href='javascript:;' class='winClose' title='关闭'></a></span></div><iframe frameborder='0' name='myFrame_"
		+id
		+"' id='myFrame_"
		+id
	...
	addWinTab:function(text,id){
		var myData=myLib.desktop.getMydata();
 		var $task_lb=myData.panel.taskBar['task_lb']
		    ...
		    ,docHtml="<a href='javascript:;' id='"+tid+"'>"+text+"</a>";
